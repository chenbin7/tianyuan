...
/**
 * Servlet implementation class changxiao
 */
@WebServlet("/changxiao")
public class changxiao extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("doPost  changxiao");
	...
	private void doGetChangxiaoBooks(HttpServletResponse response) {
		System.out.println("changxiao X");
		try {
			Connection connection = (Connection) JdbcUtil.getConnect();	
			String sql = "select * from book order by sellsum desc limit 0,10";
