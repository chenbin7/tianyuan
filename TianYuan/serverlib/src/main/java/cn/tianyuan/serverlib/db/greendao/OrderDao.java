...
public class OrderDao extends AbstractDao<Order, String> {
    ...
    public static class Properties {
        ...
        public final static Property AddrId = new Property(2, String.class, "addrId", false, "ADDR_ID");
    ...
    protected final void bindValues(DatabaseStatement stmt, Order entity) {
        ...
        String addrId = entity.getAddrId();
        if (addrId != null) {
            stmt.bindString(3, addrId);
        }
    ...
    public Order readEntity(Cursor cursor, int offset) {
        Order entity = new Order( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // addrId
    ...
    public void readEntity(Cursor cursor, Order entity, int offset) {
        ...
        entity.setAddrId(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
